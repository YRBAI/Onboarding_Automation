...
### Getting Help
- Review onboarding workflow settings in `config.py`
- Check processing logs in console output
- Verify API connectivity and credentials
- Contact Product Onboarding team for access issues

### Contributing
Internal improvements welcome! Priority areas:
- Enhanced risk taxonomy for new product types
- Additional regulatory data sources
- Performance optimization for peak onboarding periods
- Workflow integration with upstream systems

---

## 📄 Compliance & Governance

**System Classification**: Internal use only  
**Data Handling**: All fund data processed in accordance with information security policies  
**Audit Trail**: Complete logging of data sources and transformations  
**Access Control**: API credentials managed per security standards

---

## 🙏 Acknowledgments

- **Morningstar** for regulatory data and documentation access
- **Financial Times** for comprehensive market data coverage
- **Sentence Transformers** for ML-powered risk classification
- **Product Onboarding Team** for workflow requirements and testing

---

**System Version**: 2.0  
**Last Updated**: December 2024  
**Maintained by**: Investment Operations & Technology Team  
**Primary Use Case**: Mass retail fund onboarding automation
